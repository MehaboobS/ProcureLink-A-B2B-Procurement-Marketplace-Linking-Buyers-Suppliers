...
const buyerStats = [
  { label: "Requirements Posted", value: "0", icon: BarChart3, color: "bg-blue-50 text-blue-600" },
  { label: "Active Bids", value: "0", icon: TrendingUp, color: "bg-green-50 text-green-600" },
  { label: "Connections", value: "0", icon: Users, color: "bg-purple-50 text-purple-600" },
  { label: "Profile Views", value: "0", icon: Eye, color: "bg-amber-50 text-amber-600" }
];

const supplierStats = [
  { label: "Products Listed", value: "0", icon: Package, color: "bg-blue-50 text-blue-600" },
  { label: "Active Bids", value: "0", icon: TrendingUp, color: "bg-green-50 text-green-600" },
  { label: "Connections", value: "0", icon: Users, color: "bg-purple-50 text-purple-600" },
  { label: "Profile Views", value: "0", icon: Eye, color: "bg-amber-50 text-amber-600" }
];
...
export default function DashboardPage() {
  ...
  return (
    <div className="p-6 md:p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-slate-900">{role === "BUYER" ? "Buyer Dashboard" : "Supplier Dashboard"}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="p-6">
          ...
          <p className="text-sm text-slate-600">Complete your profile to improve discovery by buyers/suppliers.</p>
        </Card>
      </div>
    </div>
  );
